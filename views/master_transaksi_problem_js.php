			...
			if(isUpload && !isValidAFileSize('#form_create_'+grid+' input.multifile', uploadLimit)) {
				...
				success: function(data) {
					...
					$('#grid_'+grid).trigger('reloadGrid');
						info = 'info';
						header = 'Info';
						$.get(base_url+'processor/ss/transaksi/support/request?action=update&id='+last_id+'&foreign_key='+foreign_id+'&company_id='+company_id+'&group_id='+group_id+'&modul_id='+modul_id, function(data) {
