...
class bi_flow_ifm extends MX_Controller { 
        ...
        switch ($action) {
            ...
            case 'download':
                ...
                if(!empty($tempat) && file_exists($tempat)){ /*check keberadaan file*/
                    ...
                    // header("Content-Disposition:attachment; filename=\"".basename($tempat)."\"");
            ...
            case 'delete':
                $postData = $this->input->post();
                    ...
                    $this->db->where(array('id' => $get_id['id'], 'cKode_ifm' => $kode_ifm));
                    $this->db->update('hrd.biflow_ifm_log', $up);
                    // echo print_r($kode_ifm);exit;
    ...
    function searchBox_bi_flow_ifm_vKodeRef($rowData, $id) {
    ...
    function listBox_bi_flow_ifm_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_bi_flow_ifm_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_bi_flow_ifm_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_bi_flow_ifm_mKeterangan($field, $id) {
    ...
    function updateBox_bi_flow_ifm_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_bi_flow_ifm_upload_dok($field, $id)
    {   
    ...
    function updateBox_bi_flow_ifm_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_ifm_file a
    ...
    function insertBox_bi_flow_ifm_parameter($field, $id) {
    ...
    function updateBox_bi_flow_ifm_parameter($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_ifm_param";
        $data['table_key']  = "cKode_ifm";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_bi_flow_ifm_dSubmit($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_bi_flow_ifm_dSubmit($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
    ...
    function insertBox_bi_flow_ifm_mFeedback($field, $id) {
    ...
    function updateBox_bi_flow_ifm_mFeedback($field, $id, $value, $rowData) {
        // print_r($this->input->get());exit;
        $data = $this->input->get();
        $id = $data['id'];
    ...
    function insertBox_bi_flow_ifm_form_history($field, $id)
    {
        $o = '<b> - </b>';
    ...
    function updateBox_bi_flow_ifm_form_history($field, $id, $value, $rowData)
    {
        $data['id'] = $id;
        $data['field'] = $field;
