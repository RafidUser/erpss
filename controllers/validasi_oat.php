...
class validasi_oat extends MX_Controller { 
    ...
    function searchBox_validasi_oat_vKodeRef($rowData, $id) {
    ...
    function listBox_validasi_oat_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_validasi_oat_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_validasi_oat_iValidate($value, $pk, $name, $rowData){
    ...
    function listBox_validasi_oat_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_validasi_oat_mKeterangan($field, $id) {
    ...
    function updateBox_validasi_oat_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_validasi_oat_mValidate($field, $id) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<div class="col-sm-6">';
        $o .= '<textarea id="'.$id.'" name="'.$field.'" class="ckeditorField form-control" colspan="2"></textarea>';
        $o .= '<script>
    ...
    function updateBox_validasi_oat_mValidate($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<div class="col-sm-6">';
    ...
    function updateBox_validasi_oat_iValidate($field, $id, $value, $rowData) {
    ...
    function insertBox_validasi_oat_upload_dok($field, $id)
    {   
    ...
    function updateBox_validasi_oat_vModul($field, $id, $value, $rowData)
    {   
    ...
    function updateBox_validasi_oat_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_oat_file a
    ...
    function updateBox_validasi_oat_parameter($field, $id, $value, $rowData) {
    ...
    function insertBox_validasi_oat_validasi($field, $id) {
        $data['table']      = "hrd.biflow_oat_param";
        $data['table_key']  = "cKode_oat";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function updateBox_validasi_oat_validasi($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_oat_param";
        $data['table_key']  = "cKode_oat";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_validasi_oat_dSubmit_validasi($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_validasi_oat_dSubmit_validasi($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
