...
class bi_flow_sth extends MX_Controller { 
    ...
    function index($action = '') {
        ...
        $grid->addList('del','cPic','mExt','dSubmit','iValidate','iSubmit'); 
        $grid->setSortBy('id');
        $grid->setSortOrder('DESC');  

        $grid->addFields('cPic','mExt','dSubmit', 'mFeedback', 'form_history');
        ...
        switch ($action) {
            ...
            case 'delete':
                $postData = $this->input->post();
                    ...
                    $this->db->where(array('id' => $get_id['id'], 'cKode_sth' => $kode_sth));
                    $this->db->update('hrd.biflow_sth_log', $up);
                    // echo print_r($kode_sth);exit;
    ...
    function searchBox_bi_flow_sth_vKodeRef($rowData, $id) {
    ...
    function listBox_bi_flow_sth_cPic($value, $pk, $name, $rowData){
    ...
    function listBox_bi_flow_sth_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_bi_flow_sth_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_bi_flow_sth_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_bi_flow_sth_cPic($field, $id) {
    ...
    function updateBox_bi_flow_sth_cPic($field, $id, $value, $rowData) {
        $sql = "SELECT CONCAT_WS(' - ', a.cNip, a.vName) AS showshow
                FROM hrd.employee a
                WHERE a.lDeleted = 0
                AND a.cNip = '" . $value . "' ";
        ...
        $o .= '<input type="text" id="' . $id . '_id" name="' . $field . '_id" value="' . $value_dis . '" size="45">';
    ...
    function insertBox_bi_flow_sth_mExt($field, $id) {
    ...
    function updateBox_bi_flow_sth_mExt($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_bi_flow_sth_mKeterangan($field, $id) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function updateBox_bi_flow_sth_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_bi_flow_sth_upload_dok($field, $id)
    {   
    ...
    function updateBox_bi_flow_sth_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_sth_file a
    ...
    function insertBox_bi_flow_sth_parameter($field, $id) {
    ...
    function updateBox_bi_flow_sth_parameter($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_sth_param";
        $data['table_key']  = "cKode_sth";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_bi_flow_sth_dSubmit($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_bi_flow_sth_dSubmit($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
    ...
    function insertBox_bi_flow_sth_mFeedback($field, $id) {
    ...
    function updateBox_bi_flow_sth_mFeedback($field, $id, $value, $rowData) {
        // print_r($this->input->get());exit;
        $data = $this->input->get();
        $id = $data['id'];
    ...
    function insertBox_bi_flow_sth_form_history($field, $id)
    {
        $o = '<b> - </b>';
    ...
    function updateBox_bi_flow_sth_form_history($field, $id, $value, $rowData)
    {
        $data['id'] = $id;
        $data['field'] = $field;
        ...
        if ($postData['isdraft'] == 'true') {
            ...
            foreach ($rows as $key => $row) {
                ...
                foreach ($row as $k => $r) {
                    ...
                    $insert['cKode_sth_log'] = $cKode_log;
                    $insert[$k] = $r;
                ...
                unset($insert['id']);
                $this->db->insert('hrd.biflow_sth_log', $insert);
            ...
            foreach ($rows as $key => $row) {
                ...
                // echo print_r($get_id);
                // exit;
                $this->db->insert('hrd.biflow_sth_log', $update);
                // $this->db->where(array('id' =>  $get_id['id'], 'cKode_sth' =>  $kode_sth, 'lDeleted' => 0/*, 'cKode_br_log' => */));
