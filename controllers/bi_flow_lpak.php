...
class bi_flow_lpak extends MX_Controller { 
    ...
    function searchBox_bi_flow_lpak_vKodeRef($rowData, $id) {
    ...
    function listBox_bi_flow_lpak_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_bi_flow_lpak_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_bi_flow_lpak_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_bi_flow_lpak_mKeterangan($field, $id) {
    ...
    function updateBox_bi_flow_lpak_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_bi_flow_lpak_upload_dok($field, $id)
    {   
    ...
    function updateBox_bi_flow_lpak_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_lpak_file a
    ...
    function insertBox_bi_flow_lpak_parameter($field, $id) {
    ...
    function updateBox_bi_flow_lpak_parameter($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_lpak_param";
        $data['table_key']  = "cKode_lpak";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_bi_flow_lpak_dSubmit($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_bi_flow_lpak_dSubmit($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
    ...
    function insertBox_bi_flow_lpak_feedback($field, $id) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o = '<b> - </b>';
    ...
    function updateBox_bi_flow_lpak_feedback($field, $id, $value, $rowData) {
        $row        = get_object_vars($row);
