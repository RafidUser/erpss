...
class bi_flow_lpaw extends MX_Controller { 
        ...
        switch ($action) {
            ...
            case 'delete':
                $postData = $this->input->post();
                    ...
                    $this->db->where(array('id' => $get_id['id'], 'cKode_lpaw' => $kode_lpaw));
                    $this->db->update('hrd.biflow_lpaw_log', $up);
                    // echo print_r($kode_lpaw);exit;
    ...
    function searchBox_bi_flow_lpaw_vKodeRef($rowData, $id) {
    ...
    function listBox_bi_flow_lpaw_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_bi_flow_lpaw_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_bi_flow_lpaw_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_bi_flow_lpaw_mKeterangan($field, $id) {
    ...
    function updateBox_bi_flow_lpaw_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_bi_flow_lpaw_upload_dok($field, $id)
    {   
    ...
    function updateBox_bi_flow_lpaw_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_lpaw_file a
    ...
    function insertBox_bi_flow_lpaw_parameter($field, $id) {
    ...
    function updateBox_bi_flow_lpaw_parameter($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_lpaw_param";
        $data['table_key']  = "cKode_lpaw";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_bi_flow_lpaw_dSubmit($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_bi_flow_lpaw_dSubmit($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
    ...
    function insertBox_bi_flow_lpaw_mFeedback($field, $id) {
    ...
    function updateBox_bi_flow_lpaw_mFeedback($field, $id, $value, $rowData) {
        // print_r($this->input->get());exit;
        $data = $this->input->get();
        $id = $data['id'];
    ...
    function insertBox_bi_flow_lpaw_form_history($field, $id)
    {
        $o = '<b> - </b>';
    ...
    function updateBox_bi_flow_lpaw_form_history($field, $id, $value, $rowData)
    {
        $data['id'] = $id;
        $data['field'] = $field;
