...
class uat_lpak extends MX_Controller { 
    ...
    function searchBox_uat_lpak_vKodeRef($rowData, $id) {
    ...
    function listBox_uat_lpak_upload_dok($value, $pk, $name, $rowData) {
    ...
    function listBox_uat_lpak_validasi($value, $pk, $name, $rowData){
    ...
    function listBox_uat_lpak_iValidate_uat($value, $pk, $name, $rowData){
    ...
    function listBox_uat_lpak_del($value, $pk, $name, $rowData){
        // print_r($this->input->get());exit;
    ...
    function insertBox_uat_lpak_mKeterangan($field, $id) {
    ...
    function updateBox_uat_lpak_mKeterangan($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<input type="hidden" name="isdraft" id="isdraft">';
        $o .= '<div class="col-sm-6">';
    ...
    function insertBox_uat_lpak_mValidate_uat($field, $id) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<div class="col-sm-6">';
        $o .= '<textarea id="'.$id.'" name="'.$field.'" class="ckeditorField form-control" colspan="2"></textarea>';
        $o .= '<script>
    ...
    function updateBox_uat_lpak_mValidate_uat($field, $id, $value, $rowData) {
        $o = '<input type="hidden" name="cKode" value="'.$this->input->get('cKode').'">';
        $o .= '<div class="col-sm-6">';
    ...
    function updateBox_uat_lpak_iValidate_uat($field, $id, $value, $rowData) {
    ...
    function insertBox_uat_lpak_upload_dok($field, $id)
    {   
    ...
    function updateBox_uat_lpak_vModul($field, $id, $value, $rowData)
    {   
    ...
    function updateBox_uat_lpak_upload_dok($field, $id, $value, $rowData)
    {   
        // get data file
        $sql = "SELECT *
                FROM hrd.biflow_lpak_file a
    ...
    function updateBox_uat_lpak_parameter($field, $id, $value, $rowData) {
    ...
    function insertBox_uat_lpak_validasi($field, $id) {
        $data['table']      = "hrd.biflow_lpak_param";
        $data['table_key']  = "cKode_lpak";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function updateBox_uat_lpak_validasi($field, $id, $value, $rowData) {
        $data['table']      = "hrd.biflow_lpak_param";
        $data['table_key']  = "cKode_lpak";
        $data['id']         = $id;
        $data['field']      = $field;
    ...
    function insertBox_uat_lpak_dSubmit_uat($field, $id) {
        $o = '<b>Auto after submit</b>';

        return $o;
    }
    
    function updateBox_uat_lpak_dSubmit_uat($field, $id, $value, $rowData) {
        $o = '<b>Auto after submit</b>';
